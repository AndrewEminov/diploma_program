class InstitutesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @institute.save
        format.html { redirect_to @institute, notice: 'Институт успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @institute.update(institute_params)
        format.html { redirect_to @institute, notice: 'Информация о институте успешно обновлена.' }
  ...
  def destroy
    @institute.destroy
    respond_to do |format|
      format.html { redirect_to institutes_url, notice: 'Институт успешно удалён.' }
  ...
  private
    ...
    def institute_params
      params.require(:institute).permit(:name, :description, :full_name, :title)
    end
end
