...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { cover_letter: @upload.cover_letter, title: @upload.title } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { cover_letter: @upload.cover_letter, title: @upload.title } }
