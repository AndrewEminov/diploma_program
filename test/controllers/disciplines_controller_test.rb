...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { hour_count: @discipline.hour_count, literature: @discipline.literature, name: @discipline.name, semester_count: @discipline.semester_count, speciality_id: @discipline.speciality_id } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { hour_count: @discipline.hour_count, literature: @discipline.literature, name: @discipline.name, semester_count: @discipline.semester_count, speciality_id: @discipline.speciality_id } }
