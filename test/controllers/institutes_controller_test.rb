...
class InstitutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post institutes_url, params: { institute: { description: @institute.description, full_name: @institute.full_name, name: @institute.name } }
    end
  ...
  test "should update institute" do
    patch institute_url(@institute), params: { institute: { description: @institute.description, full_name: @institute.full_name, name: @institute.name } }
